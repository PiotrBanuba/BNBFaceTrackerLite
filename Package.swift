...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-63-g6aa1953f1a/BNBFaceTrackerLite.zip",
            checksum: "151ac22e313aecb50dee59da1fb9f7388305ef6c9d7881fbe996988ee5386271"
        ),
        .target(
