...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-61-g2b7f7b2a6c/BNBFaceTrackerLite.zip",
            checksum: "ba5381f0930eaa31b8a2302ec245e63f5d3740921ca37183e302a672f5d366c8"
        ),
        .target(
