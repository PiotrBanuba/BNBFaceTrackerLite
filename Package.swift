...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-62-g077d3df291/BNBFaceTrackerLite.zip",
            checksum: "dec2b4a10a721de29fca0e8961cce356f22a582585f8234c1ab5db98fd699af5"
        ),
        .target(
