...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-63-g5825a46ccf/BNBFaceTrackerLite.zip",
            checksum: "6e486265f7769121bd18e84712e5ea23aefadba23dfd40bc453edfdc732f87d2"
        ),
        .target(
